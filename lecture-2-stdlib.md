...
上文说到，为了避开ASCII控制字符，GB2312的编码空间只剩下94个了，只有33 - 126这个区间，是可用的。所以GB2312规定，编码高低字节都是从33（0X21）开始，至126（0xFF）结束，也就是说，把前述的区位码编码方案，都加上32（0x20）即可。我们把这个遵循[33, 126]规则的汉字区位编码，称之为“国标码”。
